					...
					<div class="container">
                        ...
                        @else
                            ...
                            <li class="menu-item lang-menu menu-item-has-children parent">
                                <a title="name" href="#"  role="button"></span>{{ Auth::user()->name }}</i></a>
                                <ul class="submenu lang" >
                                    <li class="menu-item" ><a title="hungary" href="#" href="{{ route('logout') }}"
                        ...
                        @endguest
								<li class="menu-item lang-menu menu-item-has-children parent">
									<a title="English" href="{{ LaravelLocalization::getLocalizedURL('en') }}"><span class="img label-before"><img src="{{asset('assets/images/lang-en.png')}}" alt="lang-en"></span>English<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu lang" >
										<li class="menu-item" ><a title="hungary" href="{{ LaravelLocalization::getLocalizedURL('ar') }}"><span class="img label-before"><img src="{{asset('assets/images/lang-hun.png')}}" alt="lang-hun"></span>Arabic</a></li>
									</ul>
								</li>
					...
					<div class="mid-section main-info-area">
						...
						<div class="wrap-icon right-section">
							...
							<div class="wrap-icon-section minicart">
                                {{app()->getLocale()}}
                                <cart-Count-Component :cart='itemCount' cartlink='{{url('Cart')}}'  />
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{url('check-out')}}" class="link-term mercado-item-title">Checkout</a>
								</li>
								<li class="menu-item">
