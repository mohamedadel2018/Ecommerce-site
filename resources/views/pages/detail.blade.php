					...
					<div class="wrap-product-detail">
						<div class="detail-media">
							<div class="product-gallery">
							  <ul class="slides">
							    ...
							    <li data-thumb="{{asset('assets/images/products/digital_28.jpg')}}">
						...
						<div class="detail-info">
                            ...
                            <div class="short-desc">
                                <ul>
                                    <li>{{Str::limit($product->dec,150)}}</li>
                                </ul>
                            </div>
                            <div class="wrap-social">
                            	<a class="link-socail" href="#"><img src="{{asset('assets/images/social-list.png')}}" alt=""></a>
                            </div>
                            <div class="wrap-price"><span class="product-price">${{$product->presentPrice()}}</span></div>
                            <div class="stock-info in-stock">
                                <p class="availability">Availability: <b>{{$product->Availability}}</b></p>
                            </div>
                            <div class="quantity">
                            	<span>Quantity:</span>
								<div class="quantity-input">
									<input type="text" name="product-quatity" value="1" data-max="{{$product->Availability}}" pattern="[0-9]*" >
							...
							<div class="wrap-butons">
								<a href="{{route('cart.store',$product->id)}}" class="btn add-to-cart">Add to Cart</a>
                                <div class="wrap-btn">
								...
								<div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
											<figure><img src="{{$mightAlsoLikes->image}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
										</a>
									...
									<div class="product-info">
										<a href="#" class="product-name"><span>{{ $mightAlsoLikes->title}}</span></a>
										<div class="wrap-price"><span class="product-price">{{$mightAlsoLikes->presentPrice()}}</span></div>
									</div>
								</div>
                                @endforeach
